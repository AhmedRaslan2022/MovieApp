...
open class GrowingTextView: UITextView {
    ...
    var textDidChangeDelegate: ((_ text: String?) -> ())?
    var textDidBeginEditingDelegate = {}
    var textDidEndEditingDelegate = {}
